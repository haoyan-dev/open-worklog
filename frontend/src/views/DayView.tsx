...
export default function DayView() {
  ...
  useEffect(() => {
    console.log("[DayView] timespansQueries.data changed", {
      timespansMap,
      queryKey: ["timespans", logs.map((e) => e.id).join(",")],
  ...
  const handleOpenByUuid = async (uuid: string) => {
    ...
    try {
      ...
      console.warn("[DayView] Failed to open entry by uuid", { uuid, e });
    }
  };
            ...
            {editingEntry ? (
              ...
              <LogEntryEditor
                ...
                onTimeSpanUpdate={(timespanId, startTimestamp, endTimestamp) => {
                  console.log("[DayView] onTimeSpanUpdate called", {
                    timespanId,
                    startTimestamp,
                    endTimestamp,
                  });
              ...
              <>
                ...
                {[...logs].reverse().map((entry) => (
                  <LogEntryCard
                    ...
                    onTimeSpanUpdate={(timespanId, startTimestamp, endTimestamp) => {
                      console.log("[DayView] onTimeSpanUpdate called from LogEntryCard", {
                        timespanId,
                        startTimestamp,
                        endTimestamp,
                      });
